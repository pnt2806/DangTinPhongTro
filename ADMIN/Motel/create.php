...
if (isset($_POST["create"])) {
    ...
    if (
        ...
        echo '<script>alert("Vui lòng nhập đầy đủ thông tin"); window.location="../Motel/add.php";</script>';
        exit;
    }
    $image_path = $image;
    ...
    if ($result) {
        echo '<script>alert("Thêm mới thành công"); window.location="../Motel/index.php";</script>';
    } else {
        echo '<script language="javascript">alert("Có lỗi trong quá trình xử lý"); window.location="../Motel/add.php";</script>';
    }
} else {
    echo '<script language="javascript">alert("Tạo mới không thành công"); window.location="../Motel/add.php";</script>';
}

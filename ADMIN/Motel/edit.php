        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="text-uppercase">cập nhật phòng trọ</h1>
                        </div>
                        <div class="col-sm-6">
            ...
            <section class="content">
                ...
                $phone;
                $avatar;
                $sql = "SELECT `title`, `description`, `price`, `address`, `latlng`, `images`, `category_id`, `district_id`, `utilities`, `phone`, `approve`, `status` FROM `motel` WHERE `ID` = '$id'";
                                        ...
                                        <select class="form-select form-control" name="district" id="district">
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    $name = $row['Name'];
                                            ?>
                                                    <option value="<?php echo $id ?>" <?php if ($id == $district) echo 'selected' ?>><?php echo $name ?></option>
                                            <?php
                                                }
                                            }
                                            ?>

        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="text-uppercase">thêm người dùng</h1>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pass" name="pass" value="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="re_pass">Re Password</label>
                                        <input type="text" id="re_pass" name="re_pass" value="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="role" name="role" value="" class="form-control">
                                    </div>
